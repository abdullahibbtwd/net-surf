...
export default function StatusScreen() {
  ...
  return (
    <PortalFrame
      title="NetSurf - Service Health & Status"
    ...
    >
      <View className="rounded-2xl border border-[#E2E8F0] bg-white p-4 shadow-sm">
        <View className="flex-row items-start justify-between">
          <View className="flex-1 flex-row gap-2.5">
            ...
            <View className="flex-1">
              ...
              <Text className="text-[14px] font-semibold leading-tight text-[#0F172A]">
                Sofia, Mladost 4, bl. 412
              </Text>
              <Text className="mt-0.5 text-[12px] text-[#475569]">
                Node: <Text className="font-medium text-[#0F172A]">Sofia-East Optical Hub #12</Text>
              </Text>
            </View>
          </View>
          <View className="flex-row items-center rounded-full border border-[#A7F3D0] bg-[#ECFDF5] px-2 py-0.5">
            ...
            <Text className="text-[11px] font-semibold uppercase text-[#059669]">Synced</Text>
          </View>
        </View>
      </View>
      ...
      <View className="rounded-2xl border border-[#E2E8F0] bg-white p-4 shadow-sm">
        <View className="items-center py-2">
          <View className="mb-2.5 flex-row items-center gap-2 rounded-full border border-[#A7F3D0] bg-[#ECFDF5] px-3.5 py-1.5">
            ...
            <Text className="text-[14px] font-semibold text-[#059669]">All Systems Operational</Text>
          </View>
          ...
          <View className="mt-4 w-full flex-row gap-2 border-t border-[#E2E8F0] pt-3">
            <MetricTile label="Latency" value="4.2 ms" />
            <MetricTile label="Packet Loss" value="0.00%" valueColor="#059669" />
            <MetricTile label="Uptime" value="99.98%" />
          </View>
        </View>
      </View>
      ...
      <View className="rounded-2xl border border-[#E2E8F0] bg-white p-4 shadow-sm">
        <View className="mb-3 flex-row items-center justify-between">
          <View>
            <Text className="text-[13px] font-semibold text-[#0F172A]">District Network Grid</Text>
            <Text className="text-[12px] text-[#475569]">Metropolitan Sofia Optical Ring</Text>
          </View>
          <View className="rounded-full border border-sky-100 bg-sky-50 px-2 py-0.5">
            <Text className="text-[11px] font-semibold uppercase text-[#0EA5E9]">Live Telemetry</Text>
          </View>
        </View>
        ...
        <View className="relative h-[184px] items-center justify-center overflow-hidden rounded-xl border border-[#E2E8F0] bg-[#F8FAFC] p-2">
          ...
          <View className="absolute right-[45px] top-[110px] items-center">
            ...
            <View className="mt-1 rounded border border-[#0EA5E9]/30 bg-white px-1.5 py-0.5">
              <Text className="text-[10px] font-bold text-[#0EA5E9]">Mladost 4 (You)</Text>
            </View>
          </View>
        </View>
        ...
        <View className="mt-3 flex-row items-center justify-between px-1">
          <View className="flex-row items-center gap-1.5">
            ...
            <Text className="text-[12px] text-[#475569]">All 8 Sofia Hubs Normal</Text>
          </View>
          <View className="flex-row items-center gap-1.5">
            <View className="h-2 w-2 rounded-full bg-[#0EA5E9]" />
            <Text className="text-[12px] text-[#475569]">Your Gateway</Text>
          </View>
        </View>
      </View>
      ...
      <View className="rounded-2xl border border-[#E2E8F0] bg-white p-4 shadow-sm">
        ...
        <View className="flex-row items-center justify-between border-b border-[#E2E8F0] py-2">
          <View className="flex-row items-center gap-2">
            ...
            <Text className="text-[14px] font-semibold text-[#0F172A]">0 Active Outages</Text>
          </View>
          <View className="rounded-full border border-[#A7F3D0] bg-[#ECFDF5] px-2 py-0.5">
            <Text className="text-[12px] text-[#059669]">Normal</Text>
          </View>
        </View>
        <View className="mt-3 flex-row items-start gap-2.5">
          ...
          <View className="flex-1">
            <View className="flex-row items-center gap-2">
              <Text className="text-[13px] font-semibold text-[#0F172A]">Scheduled Maintenance</Text>
              <View className="rounded border border-amber-200 bg-amber-50 px-1.5">
                <Text className="text-[10px] font-bold text-[#8A5100]">Planned</Text>
              </View>
            </View>
            <Text className="mt-0.5 text-[12px] font-medium text-[#0EA5E9]">
              Nov 28, 02:00 – 04:30 AM (EET)
            </Text>
            <Text className="mt-1 text-[12px] leading-relaxed text-[#475569]">
              Optical backbone routine maintenance. Expected brief connection downtime: &lt; 15 mins for Mladost
              sector.
            </Text>
          </View>
        </View>
      ...
      <View className="gap-3 rounded-2xl border border-[#E2E8F0] bg-white p-5 shadow-sm">
        <View>
          <Text className="text-[13px] font-semibold text-[#0F172A]">Experiencing Local Slowness?</Text>
          <Text className="mt-0.5 text-[12px] text-[#475569]">
            Test your terminal or flag an unlisted hardware disruption.
          </Text>
        </View>
        <View className="flex-row gap-2.5">
          <Pressable className="h-12 flex-1 flex-row items-center justify-center gap-1.5 rounded-xl border border-[#0EA5E9] bg-sky-50 active:scale-[0.98]">
            ...
            <Text className="text-xs font-semibold text-[#006591]">Run Diagnostics</Text>
          </Pressable>
          <Pressable className="h-12 flex-1 flex-row items-center justify-center gap-1.5 rounded-xl bg-[#0EA5E9] active:scale-[0.98]">
            ...
            <Text className="text-xs font-semibold text-white">Report Local Issue</Text>
          </Pressable>
        </View>
